...
*Note: Edit this R Markdown file with your answers to the quesitons that follow. Many of these questions involve creating visualizations such as bar charts, histograms, and a QQ plot

- The [R Markdown Reference Guide](https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf) may be a helpful resource.
...
> Gary King, Christopher J. L. Murray, Joshua A. Salomon, and Ajay Tandon. (2004). Enhancing the Validity and Cross-Cultural Comparability of Measurement in Survey Research. *American Political Science Review*, 98(1), 191-207. [Get original article from Wayne State ULS by DOI 10.1017/S000305540400108X](http://proxy.lib.wayne.edu/login?url=http://dx.doi.org/10.1017/S000305540400108X)
